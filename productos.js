...
function printProductos(container,pCategoria, disp, todo){
//trae el archivio
...
function printProductosNoDisp(container,pCategoria, disp, todo){
//trae el archivio
fetch('productos.json')
//entonces convierte la respuesta en objetos
  .then(res => res.json())
...
printProductos("descartables","descartable","disponible");

printProductos("recargables","recargable","disponible");

printProductosNoDisp("pedido","pedido","no", true);